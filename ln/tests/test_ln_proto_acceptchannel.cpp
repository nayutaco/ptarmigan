...
TEST_F(ln, ln_accept_channel_recv_ok)
{
    ...
    memcpy(self.funding_local.pubkeys[LN_FUND_IDX_FUNDING], LN_DUMMY::PUB1, BTC_SZ_PUBKEY);
    memcpy(self.funding_remote.pubkeys[LN_FUND_IDX_FUNDING], LN_DUMMY::PUB2, BTC_SZ_PUBKEY);
