...
TEST_F(ln_htlc_flag, htlc_flag_macro_offer_fulfill)
{
    ...
    //XXX:
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_SEND_ENABLED_UNCOMMITTED(p_htlc));

    //XXX:
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_RECV_ENABLED_UNCOMMITTED(p_htlc));

    //ASSERT_FALSE(LN_HTLC_LOCAL_COMMITTED(p_htlc));
    //ASSERT_FALSE(LN_HTLC_REMOTE_COMMITTED(p_htlc));
    ...
    ASSERT_FALSE(LN_HTLC_JUST_SEND_FAIL_MALFORMED_AND_COMSIG(p_htlc));
    ...
    //XXX:
    ASSERT_TRUE(LN_HTLC_REMOTE_ADDHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ...
    //ASSERT_FALSE(LN_HTLC_LOCAL_COMMITTED(p_htlc));
    //ASSERT_TRUE(LN_HTLC_REMOTE_COMMITTED(p_htlc));
    ...
    //XXX:
    ASSERT_TRUE(LN_HTLC_LOCAL_ADDHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ...
    //ASSERT_TRUE(LN_HTLC_LOCAL_COMMITTED(p_htlc));
    //ASSERT_TRUE(LN_HTLC_REMOTE_COMMITTED(p_htlc));
    ...
    //XXX:
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_TRUE(LN_HTLC_LOCAL_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_TRUE(LN_HTLC_LOCAL_FULFILL_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ...
    //XXX:
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_TRUE(LN_HTLC_REMOTE_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_TRUE(LN_HTLC_REMOTE_FULFILL_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_RECV_ENABLED_UNCOMMITTED(p_htlc));
...
TEST_F(ln_htlc_flag, htlc_flag_macro_recv_fulfill)
{
    ...
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_TRUE(LN_HTLC_LOCAL_ADDHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ...
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_TRUE(LN_HTLC_REMOTE_ADDHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ...
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_TRUE(LN_HTLC_REMOTE_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_TRUE(LN_HTLC_REMOTE_FULFILL_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ...
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_RECV_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_TRUE(LN_HTLC_LOCAL_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_htlc));
    ASSERT_TRUE(LN_HTLC_LOCAL_FULFILL_SEND_ENABLED_UNCOMMITTED(p_htlc));
