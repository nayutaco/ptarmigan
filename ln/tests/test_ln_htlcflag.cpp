...
FAKE_VALUE_FUNC(bool, ln_commit_tx_create_remote_close, const ln_channel_t *, const ln_commit_info_t *, const ln_update_info_t *, ln_close_force_t *);
...
protected:
    virtual void SetUp() {
        ...
        RESET_FAKE(ln_commit_tx_create_remote_close)
