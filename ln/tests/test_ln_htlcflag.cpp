...
TEST_F(ln_htlc_flag, htlc_flag_macro_offer_fulfill)
{
    ...
    ASSERT_TRUE(LN_UPDATE_WILL_SEND(p_update));
    ASSERT_FALSE(LN_UPDATE_WILL_COMSIG_SEND(p_update));

    ASSERT_FALSE(LN_UPDATE_LOCAL_ADD_HTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_LOCAL_DEL_HTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_LOCAL_FULFILL_HTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_LOCAL_ADD_HTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_LOCAL_DEL_HTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_LOCAL_FULFILL_HTLC_SEND_ENABLED(p_update));

    ASSERT_FALSE(LN_UPDATE_REMOTE_ADD_HTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_DEL_HTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_FULFILL_HTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_ADD_HTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_DEL_HTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_FULFILL_HTLC_RECV_ENABLED(p_update));

    ASSERT_TRUE(LN_UPDATE_LOCAL_UNCOMMITTED(p_update));
    ASSERT_TRUE(LN_UPDATE_REMOTE_UNCOMMITTED(p_update));
    ...
    ASSERT_FALSE(LN_UPDATE_WILL_SEND(p_update));
    ASSERT_TRUE(LN_UPDATE_WILL_COMSIG_SEND(p_update));
    ...
    ASSERT_TRUE(LN_UPDATE_REMOTE_ADD_HTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_DEL_HTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_FULFILL_HTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_ADD_HTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_DEL_HTLC_RECV_ENABLED(p_update));
    ...
    ASSERT_TRUE(LN_UPDATE_LOCAL_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_UPDATE_IRREVOCABLY_COMMITTED(p_update));
    ...
    ASSERT_TRUE(LN_UPDATE_LOCAL_ADD_HTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_LOCAL_DEL_HTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_LOCAL_FULFILL_HTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_LOCAL_ADD_HTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_LOCAL_DEL_HTLC_SEND_ENABLED(p_update));
    ...
    ASSERT_FALSE(LN_UPDATE_LOCAL_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_UPDATE_IRREVOCABLY_COMMITTED(p_update));
    ASSERT_TRUE(LN_UPDATE_COMSIGING(p_update));
    ...
    ASSERT_FALSE(LN_UPDATE_LOCAL_ADD_HTLC_SEND_ENABLED(p_update));
    ASSERT_TRUE(LN_UPDATE_LOCAL_DEL_HTLC_RECV_ENABLED(p_update));
    ASSERT_TRUE(LN_UPDATE_LOCAL_FULFILL_HTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_LOCAL_ADD_HTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_LOCAL_DEL_HTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_LOCAL_FULFILL_HTLC_SEND_ENABLED(p_update));
    ...
    ASSERT_FALSE(LN_UPDATE_REMOTE_ADD_HTLC_RECV_ENABLED(p_update));
    ASSERT_TRUE(LN_UPDATE_REMOTE_DEL_HTLC_SEND_ENABLED(p_update));
    ASSERT_TRUE(LN_UPDATE_REMOTE_FULFILL_HTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_ADD_HTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_DEL_HTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_FULFILL_HTLC_RECV_ENABLED(p_update));
...
TEST_F(ln_htlc_flag, htlc_flag_macro_recv_fulfill)
{
    ...
    ASSERT_FALSE(LN_UPDATE_LOCAL_DEL_HTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_LOCAL_FULFILL_HTLC_RECV_ENABLED(p_update));
    ASSERT_TRUE(LN_UPDATE_LOCAL_ADD_HTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_LOCAL_DEL_HTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_LOCAL_FULFILL_HTLC_SEND_ENABLED(p_update));
    ...
    ASSERT_FALSE(LN_UPDATE_REMOTE_DEL_HTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_FULFILL_HTLC_SEND_ENABLED(p_update));
    ASSERT_TRUE(LN_UPDATE_REMOTE_ADD_HTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_DEL_HTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_FULFILL_HTLC_RECV_ENABLED(p_update));
    ...
    ASSERT_FALSE(LN_UPDATE_REMOTE_FULFILL_HTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_REMOTE_ADD_HTLC_SEND_ENABLED(p_update));
    ASSERT_TRUE(LN_UPDATE_REMOTE_DEL_HTLC_RECV_ENABLED(p_update));
    ASSERT_TRUE(LN_UPDATE_REMOTE_FULFILL_HTLC_RECV_ENABLED(p_update));
    ...
    ASSERT_FALSE(LN_UPDATE_LOCAL_FULFILL_HTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_UPDATE_LOCAL_ADD_HTLC_RECV_ENABLED(p_update));
    ASSERT_TRUE(LN_UPDATE_LOCAL_DEL_HTLC_SEND_ENABLED(p_update));
    ASSERT_TRUE(LN_UPDATE_LOCAL_FULFILL_HTLC_SEND_ENABLED(p_update));
...
TEST_F(ln_htlc_flag, htlc_flag_update_add_htlc_resend)
{
    ...
    p_flags->up_send = 1;
    p_flags->cs_send = 1;
    p_flags->ra_recv = 0; //comsiging!
    p_flags->cs_recv = 0;
    p_flags->ra_send = 0;

    ASSERT_TRUE(LN_UPDATE_ENABLED(p_update));
