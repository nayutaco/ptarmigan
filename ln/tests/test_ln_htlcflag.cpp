...
TEST_F(ln_htlc_flag, htlc_flag_macro_offer_fulfill)
{
    ...
    ASSERT_FALSE(LN_HTLC_ENABLE_LOCAL_DELHTLC_SEND(p_htlc));
    ASSERT_FALSE(LN_HTLC_ENABLE_LOCAL_FULFILL_SEND(p_htlc));

    ASSERT_FALSE(LN_HTLC_ENABLE_REMOTE_ADDHTLC_RECV(p_htlc));
    ASSERT_FALSE(LN_HTLC_ENABLE_REMOTE_DELHTLC_SEND(p_htlc));
    ASSERT_FALSE(LN_HTLC_ENABLE_REMOTE_FULFILL_SEND(p_htlc));
    ASSERT_FALSE(LN_HTLC_ENABLE_REMOTE_ADDHTLC_SEND(p_htlc));
    ...
    ASSERT_TRUE(LN_HTLC_ENABLE_LOCAL_ADDHTLC_SEND(p_htlc));
    ASSERT_FALSE(LN_HTLC_ENABLE_LOCAL_DELHTLC_RECV(p_htlc));
    ASSERT_FALSE(LN_HTLC_ENABLE_LOCAL_FULFILL_RECV(p_htlc));
    ASSERT_FALSE(LN_HTLC_ENABLE_LOCAL_ADDHTLC_RECV(p_htlc));
    ASSERT_FALSE(LN_HTLC_ENABLE_LOCAL_DELHTLC_SEND(p_htlc));
    ...
    ASSERT_FALSE(LN_HTLC_ENABLE_REMOTE_ADDHTLC_RECV(p_htlc));
    ASSERT_TRUE(LN_HTLC_ENABLE_REMOTE_DELHTLC_SEND(p_htlc));
    ASSERT_TRUE(LN_HTLC_ENABLE_REMOTE_FULFILL_SEND(p_htlc));
    ASSERT_FALSE(LN_HTLC_ENABLE_REMOTE_ADDHTLC_SEND(p_htlc));
    ASSERT_FALSE(LN_HTLC_ENABLE_REMOTE_DELHTLC_RECV(p_htlc));
    ASSERT_FALSE(LN_HTLC_ENABLE_REMOTE_FULFILL_RECV(p_htlc));
...
TEST_F(ln_htlc_flag, htlc_flag_macro_recv_fulfill)
{
    ...
    ASSERT_FALSE(LN_HTLC_ENABLE_REMOTE_DELHTLC_SEND(p_htlc));
    ASSERT_FALSE(LN_HTLC_ENABLE_REMOTE_FULFILL_SEND(p_htlc));
    ASSERT_TRUE(LN_HTLC_ENABLE_REMOTE_ADDHTLC_SEND(p_htlc));
    ASSERT_FALSE(LN_HTLC_ENABLE_REMOTE_DELHTLC_RECV(p_htlc));
    ASSERT_FALSE(LN_HTLC_ENABLE_REMOTE_FULFILL_RECV(p_htlc));
    ...
    ASSERT_FALSE(LN_HTLC_ENABLE_LOCAL_FULFILL_RECV(p_htlc));
    ASSERT_FALSE(LN_HTLC_ENABLE_LOCAL_ADDHTLC_RECV(p_htlc));
    ASSERT_TRUE(LN_HTLC_ENABLE_LOCAL_DELHTLC_SEND(p_htlc));
    ASSERT_TRUE(LN_HTLC_ENABLE_LOCAL_FULFILL_SEND(p_htlc));
