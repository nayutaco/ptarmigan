...
TEST_F(ln_htlc_flag, htlc_flag_macro_offer_fulfill)
{
    ...
    ASSERT_TRUE(LN_HTLC_WILL_ADDHTLC_SEND(p_update));
    ASSERT_FALSE(LN_HTLC_WILL_DELHTLC_SEND(p_update));
    ASSERT_FALSE(LN_HTLC_WILL_COMSIG_SEND_OFFERED_HTLC(p_update));
    ASSERT_FALSE(LN_HTLC_WILL_COMSIG_SEND_RECEIVED_HTLC(p_update));

    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_SEND_ENABLED(p_update));

    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_RECV_ENABLED(p_update));

    //XXX:
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_SEND_ENABLED_UNCOMMITTED(p_update));

    //XXX:
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_RECV_ENABLED_UNCOMMITTED(p_update));

    //ASSERT_FALSE(LN_HTLC_LOCAL_COMMITTED(p_update));
    //ASSERT_FALSE(LN_HTLC_REMOTE_COMMITTED(p_update));

    ASSERT_FALSE(LN_HTLC_JUST_SEND_ADDHTLC_AND_COMSIG(p_update));
    ASSERT_FALSE(LN_HTLC_JUST_SEND_FULFILL_AND_COMSIG(p_update));
    ASSERT_FALSE(LN_HTLC_JUST_SEND_FAIL_AND_COMSIG(p_update));
    ASSERT_FALSE(LN_HTLC_JUST_SEND_FAIL_MALFORMED_AND_COMSIG(p_update));

    ASSERT_FALSE(LN_HTLC_COMSIGING(p_update));
    ASSERT_TRUE(LN_HTLC_TEST_EXCLUSIVENESS(p_update));

    //update_add_htlc送信
    p_flags->updsend = 1;

    ASSERT_FALSE(LN_HTLC_WILL_ADDHTLC_SEND(p_update));
    ASSERT_FALSE(LN_HTLC_WILL_DELHTLC_SEND(p_update));
    ASSERT_TRUE(LN_HTLC_WILL_COMSIG_SEND_OFFERED_HTLC(p_update));
    ASSERT_FALSE(LN_HTLC_WILL_COMSIG_SEND_RECEIVED_HTLC(p_update));
    ...
    ASSERT_TRUE(LN_HTLC_REMOTE_ADDHTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_RECV_ENABLED(p_update));
    ...
    //XXX:
    ASSERT_TRUE(LN_HTLC_REMOTE_ADDHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ...
    //ASSERT_FALSE(LN_HTLC_LOCAL_COMMITTED(p_update));
    //ASSERT_TRUE(LN_HTLC_REMOTE_COMMITTED(p_update));

    ASSERT_TRUE(LN_HTLC_JUST_SEND_ADDHTLC_AND_COMSIG(p_update));
    ASSERT_FALSE(LN_HTLC_JUST_SEND_FULFILL_AND_COMSIG(p_update));
    ASSERT_FALSE(LN_HTLC_JUST_SEND_FAIL_AND_COMSIG(p_update));
    ASSERT_FALSE(LN_HTLC_JUST_SEND_FAIL_MALFORMED_AND_COMSIG(p_update));

    ASSERT_TRUE(LN_HTLC_COMSIGING(p_update));
    ASSERT_TRUE(LN_HTLC_TEST_EXCLUSIVENESS(p_update));
    ...
    ASSERT_TRUE(LN_HTLC_LOCAL_ADDHTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_SEND_ENABLED(p_update));
    ...
    //XXX:
    ASSERT_TRUE(LN_HTLC_LOCAL_ADDHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ...
    //ASSERT_TRUE(LN_HTLC_LOCAL_COMMITTED(p_update));
    //ASSERT_TRUE(LN_HTLC_REMOTE_COMMITTED(p_update));
    ...
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_SEND_ENABLED(p_update));
    ASSERT_TRUE(LN_HTLC_LOCAL_DELHTLC_RECV_ENABLED(p_update));
    ASSERT_TRUE(LN_HTLC_LOCAL_FULFILL_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_SEND_ENABLED(p_update));
    ...
    //XXX:
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_TRUE(LN_HTLC_LOCAL_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_TRUE(LN_HTLC_LOCAL_FULFILL_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_SEND_ENABLED_UNCOMMITTED(p_update));
    ...
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_RECV_ENABLED(p_update));
    ASSERT_TRUE(LN_HTLC_REMOTE_DELHTLC_SEND_ENABLED(p_update));
    ASSERT_TRUE(LN_HTLC_REMOTE_FULFILL_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_RECV_ENABLED(p_update));
    ...
    //XXX:
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_TRUE(LN_HTLC_REMOTE_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_TRUE(LN_HTLC_REMOTE_FULFILL_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_RECV_ENABLED_UNCOMMITTED(p_update));
...
TEST_F(ln_htlc_flag, htlc_flag_macro_recv_fulfill)
{
    ...
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_RECV_ENABLED(p_update));
    ASSERT_TRUE(LN_HTLC_LOCAL_ADDHTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_SEND_ENABLED(p_update));
    ...
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_TRUE(LN_HTLC_LOCAL_ADDHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_SEND_ENABLED_UNCOMMITTED(p_update));
    ...
    ASSERT_FALSE(LN_HTLC_WILL_DELHTLC_SEND(p_update));
    ASSERT_FALSE(LN_HTLC_WILL_COMSIG_SEND_OFFERED_HTLC(p_update));
    ASSERT_TRUE(LN_HTLC_WILL_COMSIG_SEND_RECEIVED_HTLC(p_update));
    ...
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_SEND_ENABLED(p_update));
    ASSERT_TRUE(LN_HTLC_REMOTE_ADDHTLC_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_RECV_ENABLED(p_update));
    ...
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_TRUE(LN_HTLC_REMOTE_ADDHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_RECV_ENABLED_UNCOMMITTED(p_update));
    ...
    ASSERT_FALSE(LN_HTLC_WILL_ADDHTLC_SEND(p_update));
    ASSERT_TRUE(LN_HTLC_WILL_DELHTLC_SEND(p_update));
    ASSERT_FALSE(LN_HTLC_WILL_COMSIG_SEND_OFFERED_HTLC(p_update));
    ASSERT_FALSE(LN_HTLC_WILL_COMSIG_SEND_RECEIVED_HTLC(p_update));
    ...
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_SEND_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_SEND_ENABLED(p_update));
    ASSERT_TRUE(LN_HTLC_REMOTE_DELHTLC_RECV_ENABLED(p_update));
    ASSERT_TRUE(LN_HTLC_REMOTE_FULFILL_RECV_ENABLED(p_update));
    ...
    ASSERT_FALSE(LN_HTLC_REMOTE_FULFILL_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_REMOTE_ADDHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_TRUE(LN_HTLC_REMOTE_DELHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_TRUE(LN_HTLC_REMOTE_FULFILL_RECV_ENABLED_UNCOMMITTED(p_update));
    ...
    ASSERT_FALSE(LN_HTLC_JUST_SEND_ADDHTLC_AND_COMSIG(p_update));
    ASSERT_TRUE(LN_HTLC_JUST_SEND_FULFILL_AND_COMSIG(p_update));
    ASSERT_FALSE(LN_HTLC_JUST_SEND_FAIL_AND_COMSIG(p_update));
    ASSERT_FALSE(LN_HTLC_JUST_SEND_FAIL_MALFORMED_AND_COMSIG(p_update));
    ...
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_RECV_ENABLED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_RECV_ENABLED(p_update));
    ASSERT_TRUE(LN_HTLC_LOCAL_DELHTLC_SEND_ENABLED(p_update));
    ASSERT_TRUE(LN_HTLC_LOCAL_FULFILL_SEND_ENABLED(p_update));
    ...
    ASSERT_FALSE(LN_HTLC_LOCAL_FULFILL_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_FALSE(LN_HTLC_LOCAL_ADDHTLC_RECV_ENABLED_UNCOMMITTED(p_update));
    ASSERT_TRUE(LN_HTLC_LOCAL_DELHTLC_SEND_ENABLED_UNCOMMITTED(p_update));
    ASSERT_TRUE(LN_HTLC_LOCAL_FULFILL_SEND_ENABLED_UNCOMMITTED(p_update));
...
TEST_F(ln_htlc_flag, htlc_flag_macro_recv_fail)
{
    ...
    ASSERT_FALSE(LN_HTLC_JUST_SEND_ADDHTLC_AND_COMSIG(p_update));
    ASSERT_FALSE(LN_HTLC_JUST_SEND_FULFILL_AND_COMSIG(p_update));
    ASSERT_TRUE(LN_HTLC_JUST_SEND_FAIL_AND_COMSIG(p_update));
    ASSERT_FALSE(LN_HTLC_JUST_SEND_FAIL_MALFORMED_AND_COMSIG(p_update));
...
TEST_F(ln_htlc_flag, htlc_flag_offer_timeout)
{
    ...
    ln_htlc_flags_t bak = p_update->flags;
...
TEST_F(ln_htlc_flag, htlc_flag_update_add_htlc_resend)
{
    ...
    ASSERT_TRUE(LN_HTLC_ENABLED(p_update));
    ASSERT_TRUE(LN_HTLC_REMOTE_COMSIGING(p_update));
    LN_HTLC_ENABLE_RESEND(p_update);
    ASSERT_TRUE(LN_HTLC_WILL_ADDHTLC_SEND(p_update));
    p_flags->updsend = 1;
    ASSERT_TRUE(LN_HTLC_WILL_COMSIG_SEND(p_update));
