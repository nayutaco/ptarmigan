...
bool HIDDEN ln_revoke_and_ack_recv(ln_channel_t *pChannel, const uint8_t *pData, uint16_t Len)
{
    ...
    ln_derkey_remote_update_script_pubkeys(
        &pChannel->keys_remote, &pChannel->keys_local,
        pChannel->keys_static_remotekey);
...
static bool revoke_and_ack_send(ln_channel_t *pChannel)
{
    ...
    ln_derkey_local_update_script_pubkeys(&pChannel->keys_local, &pChannel->keys_remote, pChannel->keys_static_remotekey);
