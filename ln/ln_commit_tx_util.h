 ...
 *  under the License.
 */
/** @file   ln_commit_tx_util.h
 *  @brief  ln_commit_tx_util
 */
#ifndef LN_COMMIT_TX_UTIL_H__
#define LN_COMMIT_TX_UTIL_H__
...
/** @enum   ln_commit_tx_output_type_t
...
/** @struct ln_commit_tx_base_fee_info_t
 *  @brief  base fee info
 */
typedef struct {
...
} ln_commit_tx_base_fee_info_t;


/** @struct ln_commit_tx_htlc_info_t
 *  @brief  HTLC情報
 */
typedef struct {
    ln_commit_tx_output_type_t  type;               ///< output type
    uint16_t        htlc_idx;                       ///< 対応するpChannel->update_info.htlcs[]のindex値
...
} ln_commit_tx_htlc_info_t;


/** @struct ln_commit_tx_info_t
