...
#define LN_HTLCFLAG_SFT_TIMEOUT         ( \
                                            LN_HTLCFLAG_SFT_REVSEND | \
                                            LN_HTLCFLAG_SFT_COMRECV | \
                                            LN_HTLCFLAG_SFT_REVRECV | \
                                            LN_HTLCFLAG_SFT_COMSEND | \
                                            LN_HTLCFLAG_SFT_UPDSEND | \
                                            LN_HTLCFLAG_SFT_ADDHTLC(LN_ADDHTLC_SEND) \
                                        )
