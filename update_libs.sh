...
func_tag lmdb https://github.com/LMDB/lmdb.git mdb.master refs/tags/LMDB_0.9.22
func_tag mbedtls https://github.com/ARMmbed/mbedtls.git development mbedtls-2.13.1
func_tag jansson https://github.com/akheron/jansson.git master refs/tags/v2.11
func_tag curl https://github.com/curl/curl.git master refs/tags/curl-7_61_1
