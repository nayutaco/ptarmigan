...
func_tag inih https://github.com/benhoyt/inih.git master refs/tags/r45
func_tag lmdb https://github.com/LMDB/lmdb.git mdb.master refs/tags/LMDB_0.9.24
func_tag mbedtls https://github.com/ARMmbed/mbedtls.git master mbedtls-2.16.3
func_tag jansson https://github.com/akheron/jansson.git master refs/tags/v2.12
func_tag curl https://github.com/curl/curl.git master refs/tags/curl-7_66_0
