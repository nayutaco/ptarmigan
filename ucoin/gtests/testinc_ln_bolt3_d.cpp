...
TEST_F(ln_bolt3_d, gene1)
{
    ...
    //DumpBin(output, UCOIN_SZ_PRIVKEY);
    ASSERT_EQ(0, memcmp(OUTPUT, output, UCOIN_SZ_PRIVKEY));
}
...
TEST_F(ln_bolt3_d, storage0)
{
    ...
    ln_derkey_create_secret(output, SEED, I);
    ASSERT_EQ(0, memcmp(OUTPUT1, output, UCOIN_SZ_PRIVKEY));
    ...
    ln_derkey_create_secret(output, SEED, I);
    ASSERT_EQ(0, memcmp(OUTPUT2, output, UCOIN_SZ_PRIVKEY));
    ret = ln_derkey_storage_insert_secret(&storage, output, I);
    ASSERT_TRUE(ret);
    ...
    ln_derkey_create_secret(output, SEED, I);
    ASSERT_EQ(0, memcmp(OUTPUT3, output, UCOIN_SZ_PRIVKEY));
    ret = ln_derkey_storage_insert_secret(&storage, output, I);
    ASSERT_TRUE(ret);
    ...
    ln_derkey_create_secret(output, SEED, I);
    ASSERT_EQ(0, memcmp(OUTPUT4, output, UCOIN_SZ_PRIVKEY));
    ret = ln_derkey_storage_insert_secret(&storage, output, I);
    ASSERT_TRUE(ret);
    ...
    ln_derkey_create_secret(output, SEED, I);
    ASSERT_EQ(0, memcmp(OUTPUT5, output, UCOIN_SZ_PRIVKEY));
    ret = ln_derkey_storage_insert_secret(&storage, output, I);
    ASSERT_TRUE(ret);
    ...
    ln_derkey_create_secret(output, SEED, I);
    ASSERT_EQ(0, memcmp(OUTPUT6, output, UCOIN_SZ_PRIVKEY));
    ret = ln_derkey_storage_insert_secret(&storage, output, I);
    ASSERT_TRUE(ret);
    ...
    ln_derkey_create_secret(output, SEED, I);
    ASSERT_EQ(0, memcmp(OUTPUT7, output, UCOIN_SZ_PRIVKEY));
    ret = ln_derkey_storage_insert_secret(&storage, output, I);
    ASSERT_TRUE(ret);
    ...
    ln_derkey_create_secret(output, SEED, I);
    ASSERT_EQ(0, memcmp(OUTPUT8, output, UCOIN_SZ_PRIVKEY));
    ret = ln_derkey_storage_insert_secret(&storage, output, I);
    ASSERT_TRUE(ret);
...
//            printf("    S:");
//            DumpBin(storage.storage[lp].secret, UCOIN_SZ_PRIVKEY);
//            printf("\n");
//        }
//    }
